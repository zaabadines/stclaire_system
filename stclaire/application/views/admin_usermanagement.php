<div class="left-sidebar-pro">
    <nav id="sidebar" class="">
        <div class="sidebar-header">
            ...
            <strong><a href="index.html"><img src="<?=base_url()?>img/logo/logosn.png" alt="" /></a></strong>
        </div>
        <div class="left-custom-menu-adp-wrap comment-scrollbar">
            <nav class="sidebar-nav left-sidebar-menu-pro">
                <ul class="metismenu" id="menu1">
                    ...
                    <li>
                        <a title="Landing Page" href="events.html" aria-expanded="false"><span class="educate-icon educate-event icon-wrap sub-icon-mg" aria-hidden="true"></span> <span class="mini-click-non">Students</span></a>
                    </li>
                    <li>
...
<div class="all-content-wrapper">
    ...
    <div class="analytics-sparkle-area">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-12 col-md-4 col-lg-4 col-xs-12" style="border: px solid red;">
                    <button type="submit" class="btn btn-custon-rounded-one btn-primary" data-toggle="modal" data-target="#addStudent"><i class="fa fa-plus" aria-hidden="true"></i> Add Student</button>
                </div>
                <div class="col-sm-12 col-md-4 col-lg-4 col-xs-12" style="border: px solid red;">
                    <button type="submit" class="btn btn-custon-rounded-one btn-primary" data-target="#addStudent"><i class="fa fa-plus" aria-hidden="true"></i> Add Teacher</button>
                </div>
                <div class="col-sm-12 col-md-4 col-lg-4 col-xs-12" style="border: px solid red;">
                    <button type="submit" class="btn btn-custon-rounded-one btn-primary" data-toggle="modal" data-target="#addStudent"><i class="fa fa-plus" aria-hidden="true"></i> Add Principal</button>
                </div> 
            </div>
        </div>
    </div>
...
<!-- Add Student -->
<div id="addStudent" class="modal modal-edu-general default-popup-PrimaryModal fade" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-sm-12 col-md-12 col-lg-12 col-xs-12">
                        <h4 style="text-align:left; margin-bottom: 15px;">PARENT/GUARDIAN</h4>
                    </div>
                    <div class="col-sm-12 col-md-4 col-lg-4 col-xs-12">
                        <h5> First Name </h5>
                        <input name="address" type="text" class="form-control" placeholder="Boss">
                    </div>
                    <div class="col-sm-12 col-md-4 col-lg-4 col-xs-12">
                        <h5> Middle Name </h5>
                        <input name="address" type="text" class="form-control" placeholder="Zed">
                    </div>
                    <div class="col-sm-12 col-md-4 col-lg-4 col-xs-12">
                        <h5> Last Name </h5>
                        <input name="address" type="text" class="form-control" placeholder="Abadines">
                    </div>
                </div>
                <hr style="border-color: #e7e7e7; margin-top: 30px; margin-bottom: 30px;">
                <div class="row" style="margin-bottom: 20px;">
                    <div class="col-sm-12 col-md-12 col-lg-12 col-xs-12">
                        <h4 style="text-align:left; margin-bottom: 15px;">STUDENT</h4>
                    </div>
                    <div class="col-sm-12 col-md-4 col-lg-4 col-xs-12">
                        <h5> First Name </h5>
                        <input name="address" type="text" class="form-control" placeholder="Boss">
                ...
                <div class="row">
                    <div class="col-sm-6 col-md-6 col-lg-6 col-xs-6">
                        <select name="section" class="form-control">
                            ...
                            <option value="0">B491</option>
                            <option value="1">W491</option>
                        </select>
                    </div>
                    <div class="col-sm-6 col-md-6 col-lg-6 col-xs-6">
                        <select name="section" class="form-control">
                            <option value="none" selected="" disabled="">Grade Level</option>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-custon-rounded-four btn-danger" data-dismiss="modal"><i class="fa fa-times edu-danger-error" aria-hidden="true"></i> Cancel</button>
                <button type="button" class="btn btn-custon-four btn-success"><i class="fa fa-check edu-checked-pro" aria-hidden="true"></i> Add Student</button>
            </div>
        </div>
    </div>
</div>